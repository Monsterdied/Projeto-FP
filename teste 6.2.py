    ...
    while run:
        ...
        for al in die_checker:
            for oi in die_checker:
                if al == oi: continue
                elif al[0]+spedy_SIZE >= oi[0]  and al[0]<= oi[0] + spedy_SIZE+3:
...
def MyTextValue(name):
    return name
number_of_rounds = menu.add.text_input('Number_of_rounds: ', default='3', maxchar=2,onchange= MyTextValue)
