...
def start_the_game(player1,player2):
    ...
    spedy1 = pygame. transform. scale(spedy1, (spedy_size_actual_y ,spedy_SIZE+30))
    josefino1 = pygame. image. load("Jump Loop_josefino/Satyr_02_Jump Loop_000.png")
    josefino1 = pygame. transform. scale(josefino1, (josefino_size_actual_y, josefino_SIZE+30))
    merged.blit(middle_img,(0,0))
    merged.blit(bg_img,(0,0))
    merged.blit(sun_img,(0,0))
    merged.blit(gui_name,(90, 30))
    merged.blit(gui_name,(1190, 30))
    merged.blit(josefino1,(1050, 20))
    merged.blit(spedy1,(-40, 20))
    ...
    while run:
        ...
        screen.blit(score_spedy,(100, 50))
